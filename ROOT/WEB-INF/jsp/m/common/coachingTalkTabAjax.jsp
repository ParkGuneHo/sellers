...
<!-- <script type="text/javascript">
	console.log($('.comment_along').attr('name'));
	console.log($('.comment_along').next().attr('name'));

	if($('.comment_along').eq(0).attr('name') == $('.comment_along').next().attr('name')){
		$('.comment_along').eq(0).css('margin-bottom', 0);
		$('.comment_along').eq(0).css('border-bottom', 0);
	}
</script> -->
