...
<c:if test="${fn:length(defaultInfo[0].CELL_PHONE) > 6}">
                    <a href="tel:${defaultInfo[0].CELL_PHONE}" class="btn_phone_go_view"><img src="../../../images/m/icon_phone.png" alt="전화걸기"/></a>
                    <!-- 전화번호 클릭시 전화걸기 실행 됨  -->
</c:if>
                </div>
            </div>
...
<c:if test="${fn:length(defaultInfo[0].PHONE) > 6}">
            ...
            <div class="view_cata b_line">
                ...
                <div class="cont fl_l"><a href="mailto:${defaultInfo[0].EMAIL}" class="phone ds_in">${defaultInfo[0].EMAIL}</a></div>
            </div>
<%--
            <div class="view_cata b_line">
                <div class="ti fl_l">
