		                                   ...
		                                   <div class="form-group">
		                                   	...
		                                   	<div class="tab-area">
	                                            ...
	                                            <ul class="tabmenu-type">
	                                                ...
	                                                <li><a class=""  onclick="modal.goTab('2');">권한설정</a></li>
	                                            </ul>
	                                            <!--// tab-menu -->
	                                            ...
	                                            <div class="sub_cont scont2 modaltabmenu off">
	                                            	<jsp:include page="/WEB-INF/jsp/pc/clientManagement/clientCompanyInfoTerritory.jsp"/>
	                                            </div>
		                                   	</div>
 ...
 */						
		...
		setTerritory : function(){
			...
			if($("ul.checktree input[data-lv='3']:checked").length > 0){
				arr = new Array();
				$.each($("ul.checktree input[data-lv='3']:checked"), function(){
		...
		submit : function(){
				...
				var territoryGroupArr = modal.setTerritory();
				...
				(modalFlag == "ins") ? url = "/clientManagement/insertClientCompanyInfo.do" : url = "/clientManagement/updateClientCompanyInfo.do";
				 $('#formModalData').ajaxForm({
		    		...
		    		data : {
		    			datatype : 'json',
		    			browser : browser,
		    			territoryGroupArr : territoryGroupArr.toString()
		    		},
