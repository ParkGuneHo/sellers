...
<%-- 	<div class="form-group pd-t10">
			...
			<div class="form-group pd-t10">
             ...
             <div class="col-sm-4">${gridClientCompanyInfo[0].POSTAL_CODE}</div> --%>
				...
				<div class="col-sm-2">${gridClientCompanyInfo[0].POSTAL_ADDRESS}</div>
				<label class="col-sm-2 control-label ag_r"><span>홈페이지 주소</span></label>
				<div class="col-sm-2"><a href="http://${gridClientCompanyInfo[0].COMPANY_SITE}" target="_blank">${gridClientCompanyInfo[0].COMPANY_SITE}</a></div>
			</div>
<%-- 	<div class="form-group pd-t10">
	      <label class="col-sm-2 control-label ag_r"><span>주소</span></label>
...
<input type="hidden" name="hiddenCompanySite" id="hiddenCompanySite" value="${gridClientCompanyInfo[0].COMPANY_SITE}">
