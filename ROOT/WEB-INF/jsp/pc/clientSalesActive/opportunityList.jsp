                    		...
                    		<div class="mg-b20">
	               				<ul class="nav nav-tabs">
	                				...
	                				<li><a href="javascript:void(0);" onclick="oppList.tabClick(2, 1);">진행중</a></li>
	              	        		...
	              	        		<li><a href="javascript:void(0);" onclick="oppList.tabClick(4, 5);">No-Bid</a></li>
	             	        	</ul>
	                 		</div> 
                   			<!-- 탭end -->
                    	...
                    	<div class="pos-rel">
										...
										<div class="table-menu-wrapper2 fl_l mg-r10 mg-t7 m-b">
		                                    <a href="#" class="table-menu-btn" id="table-menu-btn"><i class="fa fa-th-list"></i> 항목보기 설정</a>
		                                        ...
		                                        <ul>
		                                            ...
		                                            <li><input type="checkbox" name="toggle-cols" id="toggle-col-7" value="cell_CONTRACT_DATE" 	checked="checked"> <label for="toggle-col-7">예상계약일</label></li>
		                                            <li><input type="checkbox" name="toggle-cols" id="toggle-col-8" value="cell_CONTRACT_AMOUNT" checked="checked"> <label for="toggle-col-8">계약/매출액</label></li>
	                            ...
	                            <table id="tech-companies" class="table table-bordered">
	                              ...
	                              <tr id="trCellCount">
	                                  ...
	                                  <th rowspan="2" name="cell_CONTRACT_DATE"><a href="#" class="sortLink" data-sort="OL.CONTRACT_DATE" data-method="">예상계약일 <img src="<%=request.getContextPath()%>/images/pc/icon_sort.png" /></a></th>
	                                  <th rowspan="2" name="cell_CONTRACT_AMOUNT"><a href="#" class="sortLink" data-sort="OL.CONTRACT_AMOUNT" data-method="">계약/매출액 <img src="<%=request.getContextPath()%>/images/pc/icon_sort.png" /></a></th>
...
<div class="legend-tx"> 
    ...
    <span class="mark-ti r2 mg-l10">SC</span> 영업단계(1-Validation, 2-Qualification, 3-Win Activity, 4-Contract) 
</div>
...
var oppList = {
		...
		setDetail : function(data, callback){
			...
			//사업예산
			if(!isEmpty(rowData.ERP_OPP_CD)){ 
				$("#textModalErpOppCode").val(add_comma((rowData.ERP_OPP_CD).toString()));
			}else{
				$("#textModalErpOppCode").val(0);
			}
			...
			$("#hiddenModalIdentifierId").val(rowData.IDENTIFIER_ID);
         	...
         	//Key Man
         	$("a[name='aMoveSingleClientBudget']").remove();
         	if(rowData.CLIENT_INFO_1){
				$("tbody#tbodyClientInfo #textClientInfo1").hide();
				$("tbody#tbodyClientInfo #hiddenClientInfo1").val(rowData.CLIENT_INFO_1);
             	$('tbody#tbodyClientInfo #liClientInfo1').before(
             			'<li class="value">' +
						'<span class="txt" id="'+rowData.CLIENT_INFO_1+'">'+rowData.CLIENT_INFO_1_NAME+' ['+ rowData.CLIENT_INFO_1_COMNAME +']</span>' +
						'<a href="#" class="remove" onclick="$(this).parent(\'li\').remove();removeSingleBudget(\'textClientInfo1\',\'liClientInfo1\',\'hiddenClientInfo1\',\'aMoveSingleClientBudget1\');"><i class="fa fa-times-circle"></i></a></li>' +
						'<a href="/clientManagement/viewClientIndividualInfoDetail.do?customer_id='+rowData.CLIENT_INFO_1+'&search_detail='+encodeURI(rowData.CLIENT_INFO_1_NAME)+'" target="_blank" name="aMoveSingleClientBudget" id="aMoveSingleClientBudget1" class="btn-group-sum" style="margin:6px 0 0 5px">바로가기</a>'
				);
         	}else{
         		$("tbody#tbodyClientInfo #textClientInfo1").show();
				$("tbody#tbodyClientInfo #hiddenClientInfo1").val("");
         	}
         	
         	//기안자
         	if(rowData.CLIENT_INFO_2){
				$("tbody#tbodyClientInfo #textClientInfo2").hide();
				$("tbody#tbodyClientInfo #hiddenClientInfo2").val(rowData.CLIENT_INFO_2);
             	$('tbody#tbodyClientInfo #liClientInfo2').before(
             			'<li class="value">' +
						'<span class="txt" id="'+rowData.CLIENT_INFO_2+'">'+rowData.CLIENT_INFO_2_NAME+' ['+ rowData.CLIENT_INFO_2_COMNAME +']</span>' +
						'<a href="#" class="remove" onclick="$(this).parent(\'li\').remove();removeSingleBudget(\'textClientInfo2\',\'liClientInfo2\',\'hiddenClientInfo2\',\'aMoveSingleClientBudget2\');"><i class="fa fa-times-circle"></i></a></li>' +
						'<a href="/clientManagement/viewClientIndividualInfoDetail.do?customer_id='+rowData.CLIENT_INFO_2+'&search_detail='+encodeURI(rowData.CLIENT_INFO_2_NAME)+'" target="_blank" name="aMoveSingleClientBudget" id="aMoveSingleClientBudget2" class="btn-group-sum" style="margin:6px 0 0 5px">바로가기</a>'
				);
         	}else{
         		$("tbody#tbodyClientInfo #textClientInfo2").show();
				$("tbody#tbodyClientInfo #hiddenClientInfo2").val("");
         	}
         	
         	//검토자
         	if(rowData.CLIENT_INFO_3){
				$("tbody#tbodyClientInfo #textClientInfo3").hide();
				$("tbody#tbodyClientInfo #hiddenClientInfo3").val(rowData.CLIENT_INFO_3);
             	$('tbody#tbodyClientInfo #liClientInfo3').before(
             			'<li class="value">' +
						'<span class="txt" id="'+rowData.CLIENT_INFO_3+'">'+rowData.CLIENT_INFO_3_NAME+' ['+ rowData.CLIENT_INFO_3_COMNAME +']</span>' +
						'<a href="#" class="remove" onclick="$(this).parent(\'li\').remove();removeSingleBudget(\'textClientInfo3\',\'liClientInfo3\',\'hiddenClientInfo3\',\'aMoveSingleClientBudget3\');"><i class="fa fa-times-circle"></i></a></li>' +
						'<a href="/clientManagement/viewClientIndividualInfoDetail.do?customer_id='+rowData.CLIENT_INFO_1+'&search_detail='+encodeURI(rowData.CLIENT_INFO_3_NAME)+'" target="_blank" name="aMoveSingleClientBudget" id="aMoveSingleClientBudget3" class="btn-group-sum" style="margin:6px 0 0 5px">바로가기</a>'
				);
         	}else{
         		$("tbody#tbodyClientInfo #textClientInfo3").show();
				$("tbody#tbodyClientInfo #hiddenClientInfo3").val("");
         	}
         	
         	//의사결정자
         	if(rowData.CLIENT_INFO_4){
				$("tbody#tbodyClientInfo #textClientInfo4").hide();
				$("tbody#tbodyClientInfo #hiddenClientInfo4").val(rowData.CLIENT_INFO_4);
             	$('tbody#tbodyClientInfo #liClientInfo4').before(
             			'<li class="value">' +
						'<span class="txt" id="'+rowData.CLIENT_INFO_4+'">'+rowData.CLIENT_INFO_4_NAME+' ['+ rowData.CLIENT_INFO_4_COMNAME +']</span>' +
						'<a href="#" class="remove" onclick="$(this).parent(\'li\').remove();removeSingleBudget(\'textClientInfo4\',\'liClientInfo4\',\'hiddenClientInfo4\',\'aMoveSingleClientBudget4\');"><i class="fa fa-times-circle"></i></a></li>' +
						'<a href="/clientManagement/viewClientIndividualInfoDetail.do?customer_id='+rowData.CLIENT_INFO_4+'&search_detail='+encodeURI(rowData.CLIENT_INFO_4_NAME)+'" target="_blank" name="aMoveSingleClientBudget" id="aMoveSingleClientBudget4" class="btn-group-sum" style="margin:6px 0 0 5px">바로가기</a>'
				);
         	}else{
         		$("tbody#tbodyClientInfo #textClientInfo4").show();
				$("tbody#tbodyClientInfo #hiddenClientInfo4").val("");
         	}
 ...
 */
 ...
 function removeSingleBudget(obj, obj_view, obj_hidden, obj_a){
		$("#" + obj).show();
		$("#" + obj_hidden).val("");
		$("#" + obj_a).remove();
 }
