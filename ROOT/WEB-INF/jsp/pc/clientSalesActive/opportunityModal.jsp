                            ...
                            <div class="ibox-content border_n">
                                <form class="form-horizontal" id="formModalData" name="formModalData" method="post" enctype="multipart/form-data">
                                   ...
                                   <!--  <div class="form-group pos-rel" style="display: none;"><label class="col-sm-2 control-label"><i class="fa fa-check" style="color: green;"></i> 고객사</label>
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                    	<label class="col-sm-2 control-label"><i class="fa fa-check" style="color: green;"></i> 사업예산</label>
										<div class="col-sm-4"><input type="text" class="form-control" id="textModalErpOppCode" name="textModalErpOppCode" onkeyup="comma(this);" maxlength="15" /></div>
                                        <label class="col-sm-2 control-label"><i class="fa fa-check" style="color: green;"></i> 계약/매출액</label>
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
	                                    	<label class="col-sm-2 control-label" for="date_modified"><i class="fa fa-check" style="color: green;"></i> 예상계약일</label>
	                                        <div class="col-sm-4">
	                                            <div class="data_1">
	                                       ...
	                                       <label class="col-sm-2 control-label" for="date_modified"><i class="fa fa-check" style="color: green;"></i> 사업기간</label>
		                                   <div class="col-sm-4">
                                    ...
                                    <div class="sub_cont scont1 modaltabmenu" tab-seq=1>
                                        <div class="form-group pos-rel">
                                         <label class="col-sm-2 control-label">Exec Owner</label>
                                            ...
                                            <label class="col-sm-2 control-label"><i class="fa fa-check" style="color: green;"></i> 기술대표</label>
                                            <div class="col-md-9 col-lg-4">
                                           <ul id="ulModalSingleOwner" class="flexdatalist-multiple" style="border: 1px solid rgb(204, 204, 204); border-radius: 4px; background-color: rgb(255, 255, 255);">
                                               <li class="input-container flexdatalist-multiple-value pos-rel" id="liModalSingleOwner" name="liModalSingleOwner">
                                                   <input type="text" class="form-control" id="textModalOpportunityOwner" name="textModalOpportunityOwner" placeholder="기술대표를 검색해 주세요." autocomplete="off" autoFlag="y">
                                               </li>
                                           </ul>                                                            
                                       </div>
                                        ...
                                        <div class="form-group pos-rel">
	                                       ...
	                                       <label class="col-sm-2 control-label"><i class="fa fa-check" style="color: green;"></i> 참여방법</label>
											<div class="col-sm-4">
								  ...
								  <div id="divSingleClientMasterErr" style="display:none;">
                                   ...
                                   <div class="custom-company-pop off">
                                    ...
                                    <!--// 기본정보 -->
                                        ...
                                        <div class="sub_cont scont2 modaltabmenu off" tab-seq=2>
                                            <div class="salescycle-step">
                                                <ul>
                                                    <li class="active"><a href="#"><span>Validation</span></a></li>
                                                    <li><a href="#"><span>Qualification</span></a></li>
                                                    <li><a href="#"><span>Win Activity</span></a></li>
                                            ...
                                            <div id="divSalesCycleCheck" style="padding-left:20px;">
                                            	...
                                            	<li data-category="2"><label><input type="checkbox" value="N" name="checkSalesCycle"> 고객의 의사결정 기준과 프로세스를 확인했는가 ?</label></li>
	                                ...
	                                <input type="hidden" name="hiddenModalBudgetAmount" id="hiddenModalBudgetAmount"/>
...
var modal = {
		...
		reset : function() { 
			...
			$("#formModalData #hiddenModalBudgetAmount").val("");
		...
		validate : function(){
				$("#formModalData").validate({ // joinForm에 validate를 적용
					ignore: "",
					rules : {
						textModalSubject : { //사업명
							required : true,
							maxlength : 50
						},
						hiddenModalCompanyId : { //매출처
							required : true
						},
						hiddenModalCustomerId : { //End user
							required : true
						},
						textModalErpOppCode : {	//사업예산
							required : true
						},
						textModalContractAmount : { //계약/매출액
					 		required : true
						},
						textModalContractDate : { //예상계약일
					 		required : true
						},
						textModalContractStDate : { //사업기간
							required : true
						},
						textModalContractEdDate : { //사업기간
							required : true
						},
						hiddenModalOwnerId : { //기술대표
								required : true
						},
		...
		submit : function(erpSubmitFlag){
				...
				$("#hiddenModalBudgetAmount").val(uncomma($("#textModalErpOppCode").val()));
				...
				$('#formModalData').ajaxForm({
		    		...
		    		data : {
		    			...
		    			textClientInfo1 : $("#hiddenClientInfo1").val(),
		    			textClientInfo2 : $("#hiddenClientInfo2").val(),
		    			textClientInfo3 : $("#hiddenClientInfo3").val(),
		    			textClientInfo4 : $("#hiddenClientInfo4").val()
		    		},
		            beforeSubmit: function (data,form,option) {
		            	...
		            	//매출/매입
		            	if(!winFlag_1 || !winFlag_2) return false;
