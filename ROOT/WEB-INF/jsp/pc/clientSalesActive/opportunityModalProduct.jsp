...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
				...
				<div class="clearfix mg-b5">
					<h4 style="padding-left:3px;">고객정보</h4>
				</div> 
				<div class="form-group">
		             <div class="col-sm-12">
						<table id="salesTable" class="table table-bordered ">
			              ...
			              <tbody id="tbodyClientInfo">
				              	<tr>
									  <td>
				                      		<ul class="flexdatalist-multiple" style="border: 1px solid rgb(204, 204, 204); border-radius: 4px; background-color: rgb(255, 255, 255); ">
				                                <li class="input-container flexdatalist-multiple-value pos-rel" name="liClientInfo" id="liClientInfo1" style="width: 100%;">
				                                <input type="text" class="form-control" name= "textClientInfo"  id="textClientInfo1" placeholder="고객명을 검색해 주세요." autocomplete="off" autoFlag="y">
				                                <input type="hidden" id="hiddenClientInfo1" value=""/>
				                            </ul>
									  </td>
									  <td>
				                      		<ul class="flexdatalist-multiple" style="border: 1px solid rgb(204, 204, 204); border-radius: 4px; background-color: rgb(255, 255, 255); ">
				                                <li class="input-container flexdatalist-multiple-value pos-rel" name="liClientInfo" id="liClientInfo2" style="width: 100%;">
				                                <input type="text" class="form-control" name= "textClientInfo" id="textClientInfo2" placeholder="고객명을 검색해 주세요." autocomplete="off" autoFlag="y">
				                                <input type="hidden" id="hiddenClientInfo2" value=""/>
				                            </ul>
									  </td>
									  <td>
				                      		<ul class="flexdatalist-multiple" style="border: 1px solid rgb(204, 204, 204); border-radius: 4px; background-color: rgb(255, 255, 255); ">
				                                <li class="input-container flexdatalist-multiple-value pos-rel" name="liClientInfo" id="liClientInfo3" style="width: 100%;">
				                                <input type="text" class="form-control" name= "textClientInfo" id="textClientInfo3" placeholder="고객명을 검색해 주세요." autocomplete="off" autoFlag="y">
				                                <input type="hidden" id="hiddenClientInfo3" value=""/>
				                            </ul>
									  </td>
									  <td>
				                      		<ul class="flexdatalist-multiple" style="border: 1px solid rgb(204, 204, 204); border-radius: 4px; background-color: rgb(255, 255, 255); ">
				                                <li class="input-container flexdatalist-multiple-value pos-rel" name="liClientInfo4" id="liClientInfo4" style="width: 100%;">
				                                <input type="text" class="form-control" name= "textClientInfo" id="textClientInfo4" placeholder="고객명을 검색해 주세요." autocomplete="off" autoFlag="y">
				                                <input type="hidden" id="hiddenClientInfo4" value=""/>
				                            </ul>
									  </td>
			                    </tr>
		                  </tbody>
...
$(document).ready(function() { 
	...
	commonSearch.singleClientMaster($("tbody#tbodyClientInfo #textClientInfo1"), $('tbody#tbodyClientInfo #liClientInfo1'), $('tbody#tbodyClientInfo #hiddenClientInfo1'), $('#formModalData #hiddenModalClientMasterErpCode'));
	commonSearch.singleClientMaster($("tbody#tbodyClientInfo #textClientInfo2"), $('tbody#tbodyClientInfo #liClientInfo2'), $('tbody#tbodyClientInfo #hiddenClientInfo2'), $('#formModalData #hiddenModalClientMasterErpCode'));
	commonSearch.singleClientMaster($("tbody#tbodyClientInfo #textClientInfo3"), $('tbody#tbodyClientInfo #liClientInfo3'), $('tbody#tbodyClientInfo #hiddenClientInfo3'), $('#formModalData #hiddenModalClientMasterErpCode'));
	commonSearch.singleClientMaster($("tbody#tbodyClientInfo #textClientInfo4"), $('tbody#tbodyClientInfo #liClientInfo4'), $('tbody#tbodyClientInfo #hiddenClientInfo4'), $('#formModalData #hiddenModalClientMasterErpCode'));
});
