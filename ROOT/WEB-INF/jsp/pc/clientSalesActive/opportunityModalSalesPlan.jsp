		...
		<table id="tableSalesPlan" class="table basic2">
		    ...
		    <tbody id="tbodySalesPlan">
		    	 <tr class="total">
		        	...
		        	<td class="ag_c border_gap"></td>
		        	<td class="border_gap cellend"><span class="total" id="totalPlanRev" style="font-size : 13px;">0</span></td>
		        	<td class="border_gap cellend"><span class="total" id="totalPlanGp" style="font-size : 13px;">0</span></td>
		        	<td class="ag_c border_gap"></td>
		        </tr>
		    </tbody>
		</table>
