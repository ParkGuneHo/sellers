    ...
    <div id="wrapper">
        ...
        <!---//타이틀--->
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="pos-rel download">
                	<!-- <a class="down_manual" href="../../../../manual/(Sellers)manual_m_for_uni_V1.5.pdf" onclick="return; downMobileManual();" title="모바일 매뉴얼 다운" download>
	                	 <i class="fa fa-info-circle" style="font-size: 20px;color: #76a276;"></i>
	                </a>
                	<a class="down_manual" href="../../../../manual/(Sellers)manual_pc_for_uni_V1.5.pdf" onclick="return; downPcManual();" title="pc버전 매뉴얼 다운" download>
	                	 <i class="fa fa-info-circle" style="font-size: 20px;"></i>
	                </a> -->
	                <a class="down_manual" href="#" onclick="downMobileManual();" title="모바일 매뉴얼 다운">
	                	 <i class="fa fa-info-circle" style="font-size: 20px;color: #76a276;"></i>
	                </a>
                	<a class="down_manual" href="#" onclick="downPcManual();" title="pc버전 매뉴얼 다운">
	                	 <i class="fa fa-info-circle" style="font-size: 20px;"></i>
	                </a>
	                <a class="down_apk" href="#" onclick="downloadApk();" title="apk 다운로드">
	                	 <span>down</span>
	                </a>
                </li>
...
function downloadApk(){
	if(confirm("THE Seller's APK 파일을 다운로드 하시겠습니까?")){
		location.href = location.origin+"/THE_Sellers.apk";
		$.ajax({
			url : "/common/updateApkCnt.do",
			async : false,
			type : "get",
			dataType : "json",
			success : function(data){
 ...
 * 셀러스 pc 매뉴얼 파일 다운로드
 */
function downPcManual(){
	if(confirm("THE Seller's pc버전 매뉴얼을 다운로드 하시겠습니까?")){
		location.href = location.origin+"/manual/(Sellers)manual_pc_for_uni_V1.5.pdf";
	}
}

/**
 * 셀러스 mobile 매뉴얼 파일 다운로드
 */
function downMobileManual(){
	if(confirm("THE Seller's 모바일버전 매뉴얼을 다운로드 하시겠습니까?")){
		location.href = location.origin+"/manual/(Sellers)manual_m_for_uni_V1.5.pdf";
	}
}
