...
public class ClientSalesActiveService{
	...
	public Map<String, Object> insertClientContact(Map<String, Object> map, HttpServletRequest request) throws Exception {
		//캘린더 일정과 생산성 데이터 등록
		...
		//Follow Up Action 입력
		ArrayList<HashMap<String, Object>> actionGridList = CommonUtils.jsonList((map.get("contactFollowUpAction")).toString());    
