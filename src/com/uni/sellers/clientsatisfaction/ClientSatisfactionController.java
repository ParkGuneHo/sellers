...
public class ClientSatisfactionController {
	...
	public ModelAndView viewClientIssueList(CommandMap map) throws Exception{
	...
	public ModelAndView selectIssueListCount(CommandMap map) throws Exception{
	...
	public ModelAndView selectClientSatisfactionMasterListCount(CommandMap map) throws Exception{
		ModelAndView mv = new ModelAndView("jsonView");
