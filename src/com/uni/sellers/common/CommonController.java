...
public class CommonController {
	 ...
	 * @explain	: 알림 카운트 가져오기
	 */
	@RequestMapping(value="/common/selectNoticeCount.do")
	 ...
	 * @explain	: 알림 상세 가져오기
	 */
	@RequestMapping(value="/common/selectNoticeDetail.do")
	 ...
	 * @explain	: 알림 상세 가져오기
	 */
	@RequestMapping(value="/common/updateNoticeDetail.do")
	 ...
	 * @explain	: apk 다운로드 토탈
	 */
	@RequestMapping(value="/common/updateApkCnt.do")
	public ModelAndView apkCnt(CommandMap commandMap,HttpServletResponse response, HttpServletRequest request) throws Exception{
		ModelAndView mv = new ModelAndView("jsonView");
		commonDAO.updateApkCnt(commandMap.getMap());
		return mv;
	}
}