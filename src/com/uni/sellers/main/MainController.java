...
//		response.sendRedirect("/test/trackingTest.do");
	...
	public ModelAndView selectTimeLine(CommandMap map) throws Exception{
		ModelAndView mv = new ModelAndView();
		if(map.get("datatype").equals("html")){
			mv.setViewName((String)map.get("jsp"));
		}else{
	...
	public ModelAndView selectSalesAct(CommandMap map) throws Exception{
		ModelAndView mv = new ModelAndView();
		if(map.get("datatype").equals("html")){
			mv.setViewName((String)map.get("jsp"));
		}else{
		...
		List<Map<String,Object>> selectSalesAct = mainService.selectSalesAct(map.getMap());
	...
	public ModelAndView selectClientIssue(CommandMap map) throws Exception{
		ModelAndView mv = new ModelAndView();
		if(map.get("datatype").equals("html")){
			mv.setViewName((String)map.get("jsp"));
		}else{
		...
		List<Map<String,Object>> selectClientIssue = mainService.selectClientIssue(map.getMap());
